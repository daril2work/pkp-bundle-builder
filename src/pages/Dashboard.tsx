...
const Dashboard = () => {
  ...
  const recentActivities = [
    { id: 1, action: "Bundle PKP 2025 dibuat", time: "2 jam yang lalu", status: "success" },
    { id: 2, action: "Puskesmas Kec. Utara mengirim data Q1", time: "4 jam yang lalu", status: "info" },
    { id: 3, action: "Validasi data Puskesmas Kec. Selatan", time: "1 hari yang lalu", status: "pending" },
    { id: 4, action: "Laporan rekap Q4 2024 selesai", time: "2 hari yang lalu", status: "success" }
  ];

  const quarterlyProgress = [
    { quarter: "Q1 2025", completed: 8, total: 24, percentage: 33 },
    { quarter: "Q4 2024", completed: 24, total: 24, percentage: 100 },
    { quarter: "Q3 2024", completed: 22, total: 24, percentage: 92 },
    { quarter: "Q2 2024", completed: 20, total: 24, percentage: 83 }
  ];
